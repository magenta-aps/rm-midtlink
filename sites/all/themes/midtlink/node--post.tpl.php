...
";
      ?>
      <a target="_blank" href="/mailto.php?s=<?php echo rawurlencode(utf8_decode('Se dette indlæg fra MidtLink: '.$node->title)); ?>&b=<?php echo rawurlencode(utf8_decode($fwdMailMsg)); ?>" class="post-indicator email image-replacement" title="Del dette indl&aelig;g via email"></a>
